...
public class Stream {
    ...
    public Stream(String bigtName, int indexType, int orderType, String rowFilter, String columnFilter, String valueFilter, int numBuf) {
        ...
        try {
            switch (indexType) {
                case 1:
                    map_iterator = new FileScanMap(bigtName, null, cond_exprs, true);
                    break;
                default:
                    map_iterator = new CombinedScanMap(bigtName, cond_exprs, index_2_filter, index_3_filter, index_4_filter, index_5_filter);
                    break;
            }
